...
function performSearch() {
    ...
    if (searchTerm) {
        chrome.tabs.create({ url: 'https://www.bing.com/search?q=%s&udm=14' + encodeURIComponent(searchTerm) });
        chrome.tabs.create({ url: 'https://duckduckgo.com/?q=%s&udm=14' + encodeURIComponent(searchTerm) });
        chrome.tabs.create({ url: 'https://www.google.com/search?q=%s&udm=14' + encodeURIComponent(searchTerm) });
        chrome.tabs.create({ url: 'https://www.startpage.com/search?q=%s&udm=14' + encodeURIComponent(searchTerm) });
        chrome.tabs.create({ url: 'https://search.brave.com/search?q=%s&udm=14' + encodeURIComponent(searchTerm) });
